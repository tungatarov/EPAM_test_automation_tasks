...
public class ClassesMain {
    ...
    public static void main(String[] args) {
        Patient patient1 = new Patient("Smith", "John", "1883 Geneva Street","617-555-0154",109_467_103, "pneumonia");
        Patient patient2 = new Patient("Doe", "Erica","4233 Geraldine Lane","617-555-0148",100_400_131, "pneumonia");
        Patient patient3 = new Patient("Maren", "Julie", "4864 Pretty View Lane","617-555-0127",100_400_132, "pneumonia");
        Patient patient4 = new Patient("Osborn", "Norman", "4094 Bicetown Road","617-555-0177",100_400_133, "pneumonia");
        Patient patient5 = new Patient("Parker", "Peter", "20 Ingram Street","617-555-0188",300_168_466, "bronchial asthma");
        Patient patient6 = new Patient("Watson", "Mary", "2747 Hoffman Avenue","617-555-0165",300_168_541, "flu");
        Patient patient7 = new Patient("Osborn", "Harry", "748 Small Street","617-555-1333",100_400_134, "pneumonia");
